// Import Angular core functions and reactive forms
import { Component, inject, signal } from '@angular/core';
import { FormBuilder, FormControl, Validators, ReactiveFormsModule, FormArray } from '@angular/forms';

@Component({
  selector: 'app-enrollment-form',
  // Import ReactiveFormsModule - without this, Angular won't recognize form directives
...
export class EnrollmentFormComponent {
  ...
  form = this.fb.nonNullable.group({
    studentId: [
      ...
      [Validators.required, Validators.pattern('^STU-[0-9]{4}$')] // required AND must match pattern STU-1234
    ],
